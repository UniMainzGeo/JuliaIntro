...
# ╔═╡ cb6e4594-0ee0-4f48-99f5-86d37478737d
begin
	using Plots, Printf
	using Plots.PlotMeasures
end

# ╔═╡ 3b2a3ac5-5702-4044-a8a0-994ca8b8dd4b
begin
...
# ╔═╡ 25a7dd24-e383-4d58-8a60-cdab16953fb3
function update_q!(??)
...
# ╔═╡ c801b8aa-48f6-448b-b022-a8533b5d55cf
function update_C!(??)
    Threads.@threads for iz = 1:size(C, 2)
        for iy = 1:size(C, 1)
            ??
...
# ╔═╡ 1c3d1106-0f63-11ee-1979-a9c5338c4e04
@views function main()
    # physics
    ly, lz  = 1.0, 1.0
    d0      = 1.0
...
# ╔═╡ 0dea4f8d-30ee-47e7-aa7b-6316c7e98ab1
main()
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "5a2c0393dd8a382ac4258e1a7c00677e8a0db37e"
